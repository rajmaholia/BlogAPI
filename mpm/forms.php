    ...
    if($this->lap==true){
      ...
      if($this->multiple=='multiple') {
       ...
       // maxlength=\"$this->max_length\"
        $input = "<input  type='$this->type'   name='$this->name' class='class-form-control' id=\"$idArray[1]\"  style='display: block;width:100%; font-size:16px;' placeholder=\"$this->placeholder\" value=\"$this->value\" {$this->multiple}/>
...
class FileField extends InputField {
 // public $multiple;
  function __construct($label,$showLabel=true,$lap=false,$placeholder="",$multiple=''){
      parent::__construct($label,$showLabel,$lap,$placeholder,$multiple);
      $this->type = "file";
      $this->multiple=$multiple;
  }
}
